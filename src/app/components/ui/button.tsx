...
export const buttonVariants = tv({
  ...
  variants: {
    ...
    size: {
      medium: {
        root: 'h-10 gap-3 rounded-[12px] px-3.5 text-label-sm',
        icon: '-mx-1',
      },
      small: {
        root: 'h-9 gap-3 rounded-[12px] px-3 text-label-sm',
        icon: '-mx-1',
      },
      xsmall: {
        root: 'h-8 gap-2.5 rounded-[12px] px-2.5 text-label-sm',
        icon: '-mx-1',
      },
      xxsmall: {
        root: 'h-7 gap-2.5 rounded-[12px] px-2 text-label-sm',
        icon: '-mx-1',
      },
    },
  },
