...
export const fancyButtonVariants = tv({
  ...
  variants: {
    variant: {
      neutral: {
        root: 'bg-bg-strong-950 text-text-white-0 shadow-[var(--shadow-fancy-buttons-neutral)]',
      },
      primary: {
        root: 'bg-primary-base text-static-white shadow-[var(--shadow-fancy-buttons-primary)]',
      },
      destructive: {
        root: 'bg-error-base text-static-white shadow-[var(--shadow-fancy-buttons-error)]',
      },
      basic: {
        root: [
          // base
          'bg-bg-white-0 text-text-sub-600 shadow-[var(--shadow-fancy-buttons-stroke)]',
          // hover
    ...
    size: {
      medium: {
        root: 'h-10 gap-3 rounded-[12px] px-3.5',
        icon: '-mx-1',
      },
      small: {
        root: 'h-9 gap-3 rounded-[12px] px-3',
        icon: '-mx-1',
      },
      xsmall: {
        root: 'h-8 gap-3 rounded-[12px] px-2.5',
        icon: '-mx-1',
      },
    },
  },
